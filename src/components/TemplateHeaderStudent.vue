<template>
    <nav id="header" class="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="Eighth navbar example">
        <div class="container">
            <a v-if="userLoggedIn" id="logo" class="navbar-brand" href="/dashboardStudent" title="Korrekturmanagementsystem"><img src="/kms-logo.svg" alt=""></a>
            <button
            ...
            <div class="collapse navbar-collapse navbar-right" id="mainmenu">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li v-if="user" class="nav-item" @click="toHome">
                        <a class="nav-link active" aria-current="page" href="/dashboardStudent">Dashboard</a>
                    </li>
